...
(function (Snapshot) {
    ...
    const createSolidarityFile = (context) => __awaiter(this, void 0, void 0, function* () {
        ...
        const pluginsWithTemplates = ramda_1.filter(plugin => plugin.templateDirectory !== null, context._pluginsList);
        // list visible plugins
        printSeparator();
        print.info('Available technology plugins:\n');
        if (pluginsWithTemplates.length > 0) {
            const pluginOptions = ["NONE" /* NONE */];
            ...
            if (answer.selectedPlugin === "NONE" /* NONE */) {
                print.info("Nothing to do \u00AF\\_(\u30C4)_/\u00AF" /* NOTHING */);
                ...
                const runPlugin = ramda_1.head(ramda_1.filter(ramda_1.propEq('name', answer.selectedPlugin), pluginsWithTemplates));
                if (runPlugin) {
                    // run plugin
    ...
    Snapshot.run = (context) => __awaiter(this, void 0, void 0, function* () {
        ...
        if (filesystem.exists('.solidarity')) {
            ...
            if (first) {
                yield buildSpecificRequirement(context)
                    .then((newRequirement) => __awaiter(this, void 0, void 0, function* () {
                    const updatedSolidaritySettings = yield appendSolidaritySettings(context, newRequirement);
