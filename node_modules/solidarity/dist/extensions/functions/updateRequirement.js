...
module.exports = (requirement, settings, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const ruleChecks = yield map((rule) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        switch (rule.rule) {
            ...
            case 'cli':
                ...
                let updateResult;
                try {
                    updateResult = yield checkCLIForUpdates(rule, context);
                }
                catch (e) {
                    spinner.fail(e);
                    return [];
            ...
            case 'custom':
                ...
                if (customPluginRule.success) {
                    ...
                    if (!customPluginRule.plugin.snapshot)
                        return [];
                    const customResult = yield customPluginRule.plugin.snapshot(rule, context);
...
//# sourceMappingURL=updateRequirement.js.map